...
All of this couldn't be possible without our testers: Rohit as the test lead and Mani who’s been on EntLib team since very early release 1.0 and only skipped v4), to Erik for automating our security testing, and to Masashi for automating our UI testing. And praise for the doc team, Alex and Dennis for helping improve our learning story. It’s not easy to reconcile 1200 pages of the docs from so many releases.
