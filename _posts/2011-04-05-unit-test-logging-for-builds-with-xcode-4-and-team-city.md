...
We want the build to trigger every time a check in occurs so we set that up.
...
The bowling project is a Coca Framework project created with Unit Tests. It is pretty standard stuff. The only thing I did was add the logger to the project.
