...
| Name                              | Value                                                         |
| --------------------------------- |---------------------------------------------------------------|
| DYLD\_ROOT\_PATH                  | $(SDKROOT)                                                    |
| DYLD\_FRAMEWORK\_PATH             | ${BUILD\_PRODUCTS\_DIR}:${SDK\_ROOT}:${DYLD\_FRAMEWORK\_PATH} |
| IPHONE\_SIMULATOR\_ROOT           | $(SDKROOT)                                                    |
| CFFIXED\_USER\_HOME               | $(HOME)/Library/Application Support/iPhone Simulator/User/    |
| OBJC\_DISABLE\_GC                 | YES                                                           |
| DYLD\_LIBRARY\_PATH               | ${BUILD\_PRODUCTS\_DIR}:${SDK\_ROOT}:${DYLD\_LIBRARY\_PATH}   |
| DYLD\_NEW\_LOCAL\_SHARED\_REGIONS | YES                                                           |
| DYLD\_NO\_FIX\_PREBINDING         | YES                                                           |
